...
module.exports = {
  color: {
    ...
    "theme-color-error": tokens.colors.green[600],
    ...
    "theme-button-primary-hover": tokens.colors.gray[800],
    "theme-button-primary-visited": tokens.colors.gray[500],
    "theme-button-primary-active": tokens.colors.gray[400],

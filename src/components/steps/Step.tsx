...
export const State = {
  ACTIVE: "cursor-default text-gray-600 border-green-600",
  COMPLETE:
...
const Step = ({
  ...
  const stepClasses = classNames(
    `group flex flex-1 px-2 py-1 text-sm md:text-base md:pb-4 md:pt-3 md:leading-tight border-l-4 sm:border-l-0 sm:border-t-4 ${state}`
  );

  const iconClasses = classNames(
    `flex flex-shrink-0 justify-center w-6 h-6 rounded-2xl text-xs text-white`,
